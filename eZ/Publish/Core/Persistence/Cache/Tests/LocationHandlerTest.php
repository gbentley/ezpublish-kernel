...
class LocationHandlerTest extends HandlerTest
{
    ...
    public function testLoadParentLocationsForDraftContentIsMiss()
    {
        ...
        $this->cacheMock
            ->expects( $this->once() )
            ->method( 'getItem' )
            ->with( 'spi', 'content', 'locations', "44/parentLocationsForDraftContent" )
            ->will( $this->returnValue( $cacheItemMock ) );
    ...
    public function testLoadLocationsByContentWithRootIsMiss()
    {
        ...
        $this->cacheMock
            ->expects( $this->once() )
            ->method( 'getItem' )
            ->with( 'spi', 'content', 'locations', '44/root/2' )
            ->will( $this->returnValue( $cacheItemMock ) );
